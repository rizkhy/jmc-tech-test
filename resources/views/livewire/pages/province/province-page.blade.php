<section class="p-3 sm:p-5">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div
                    ...
                    <button id="defaultModalProvinceButton" data-modal-toggle="defaultModalProvince" type="button"
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">
                                    <button type="button" wire:click="edit('{{ $value->id }}')"
                                        ...
                                        data-modal-toggle="defaultModalProvince">Edit</button>
            ...
            <!-- Pagination -->
            <div class="p-4">
                {{ $provinces->links('vendor.pagination.custom-paginate') }}
            </div>
    ...
    <!-- Main modal -->
    <div id="defaultModalProvince" tabindex="-1" aria-hidden="true" wire:ignore.self
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div
                    ...
                    <button type="button"
                        ...
                        data-modal-toggle="defaultModalProvince">
